...
import (
	...
	"github.com/SageRiship/vrcasino/authservice/constants"
	"github.com/SageRiship/vrcasino/authservice/model"
...
func JSONError(w http.ResponseWriter, err map[string]interface{}, code int) {
...
func SignIn(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		JSONError(w, map[string]interface{}{"Username": credentials.Username, "Messege": "User Not Authorised"}, http.StatusUnauthorized)
		return
	}

	if resp.StatusCode != http.StatusOK {
		//http.Error(w, "User unauthorized.", resp.StatusCode)
		JSONError(w, map[string]interface{}{"errorCode": http.StatusUnauthorized, "Username": credentials.Username, "Messege": "User Not Authorised"}, http.StatusUnauthorized)
		return
	}
